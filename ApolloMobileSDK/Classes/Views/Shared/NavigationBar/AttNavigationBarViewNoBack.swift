//
//  AttNavigationBarViewNoBack.swift
//  ApolloMobileSDK
//
//  Created by Nermin Sabanovic on 17. 10. 2022..
//

import Foundation
import SwiftUI

struct AttNavigationBarViewNoBack<Content: View, NavigationContent: View>: View {
    var titleText: String
    var titleContent: (() -> NavigationContent)?
    var backgroundColor: Color = AttAppTheme.attSDKBackgroundColor
